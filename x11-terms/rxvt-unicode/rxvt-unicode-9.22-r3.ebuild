...
EAPI=7
inherit autotools eutils desktop
...
IUSE="
	...
	+perl startup-notification unicode3 +utmp +wtmp xft 24bit
"
RESTRICT="test"
...
src_prepare() {
	...
	use 24bit && eapply "${FILESDIR}"/${PN}-9.22-24bit.patch
...
src_configure() {
	...
	use 24bit && myconf='--enable-24-bit-color'
